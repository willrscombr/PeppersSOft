...
public class FrmcadProdutos extends JFrame {
	...
	public FrmcadProdutos(Produto p) {
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int opc = JOptionPane.showConfirmDialog(null, message, title,
		...
		texLucro.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent arg0) {
				...
				double margem = Double.parseDouble(texLucro.getText()), prcusto = (Double
						.parseDouble(textPrCusto.getText()));
	...
	protected void salvaProduto() throws Exception {
		...
		if (txtCod.getText().isEmpty()) {
			...
			if (textDesc.getText().isEmpty() || textEstoque.getText().isEmpty()
					|| textPrCusto.getText().isEmpty()
					|| textPrVenda.getText().isEmpty()) {
