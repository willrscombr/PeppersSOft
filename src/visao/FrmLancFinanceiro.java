			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					if(comboBox.getSelectedItem()=="Selecione"){
						JOptionPane.showMessageDialog(null, "Por favor escolha o tipo de lançamento!");
						comboBox.requestFocus();
					}
					if(txtValor.getText()== null || txtValor.getText()== ""){
						JOptionPane.showMessageDialog(null, "Atenção! O campo valor deve ser informado!");
						txtValor.requestFocus();
					}
					if(txtDiscrim.getText()== null || txtDiscrim.getText()== ""){
						JOptionPane.showMessageDialog(null, "Atenção! O campo discriminação deve ser informado!");
						txtDiscrim.requestFocus();
					}
					if(txtCodigo.getText()== null || txtCodigo.getText()== ""){
						JOptionPane.showMessageDialog(null, "Atenção! O campo conta deve ser informado!");
